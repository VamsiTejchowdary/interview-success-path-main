...
const OverviewTab = ({
  ...
  useEffect(() => {
    ...
    const fetchMetrics = async () => {
      ...
      // Interviewed
      const interviewed = allApps.filter(
  ...
  // Fetch cold email count and response count
  useEffect(() => {
        ...
        <CardContent className="p-8">
          <div>
            ...
            <p className="text-gray-600 text-lg">
              Chill out, we're taking care of your applications! Get ready for
              those interviews! 🚀
            </p>
          </div>
        </CardContent>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-8">
        <Card className="backdrop-blur-xl bg-white/60 border-white/20 shadow-lg hover:shadow-xl transition-all duration-300">
          ...
          <CardContent>
            ...
            <p
              className={`text-xs ${metrics.totalApplied - metrics.prevWeekApplied >= 0 ? "text-green-600" : "text-red-600"}`}
            >
              {metrics.totalApplied - metrics.prevWeekApplied >= 0 ? "+" : ""}
              {metrics.totalApplied - metrics.prevWeekApplied} compared to last
              week
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="backdrop-blur-xl bg-white/60 border-white/20 shadow-lg hover:shadow-xl transition-all duration-300">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-gray-800">
              {metrics.thisMonthApplied}
            </div>
            <p className="text-xs text-orange-600">
              {metrics.daysLeftInMonth} days left this month
            </p>
          </CardContent>
        </Card>
      </div>
          ...
          <Card className="backdrop-blur-xl bg-white/60 border-white/20 shadow-lg flex items-center justify-center">
            <CardContent className="flex flex-col items-center justify-center py-10">
              ...
              <div className="text-sm text-gray-500 text-center">
                You will be assigned a recruiter soon. Please check back later
