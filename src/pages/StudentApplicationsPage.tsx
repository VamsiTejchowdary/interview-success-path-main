...
const StudentApplicationsPage = () => {
  ...
  }, [applications, startDate, endDate, statusFilter, contactFilter]);
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        {filteredApplications.length === 0 ? (
          ...
          <div className="space-y-4">
            {Array.from(groupedApplications.entries()).map(([date, apps]) => {
                          ...
                          >
                            ...
                            <div className="p-4 flex items-center justify-between hover:bg-slate-800/30 transition-colors">
                              ...
                              >
                                ...
                                {app.has_contact ? "Update" : "Cold Email"}
                              </Button>
                            </div>
