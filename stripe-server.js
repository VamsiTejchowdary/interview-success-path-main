...
async function handleSubscriptionUpdated(subscription) {
  try {
    ...
    console.log('📅 New period start:', new Date(subscription.current_period_start * 1000).toISOString());
    console.log('📅 New period end:', new Date(subscription.current_period_end * 1000).toISOString());
...
async function handleInvoicePaymentSucceeded(invoice) {
  try {
    ...
    if (subscriptionId) {
      ...
      console.log('📅 Stripe subscription period start:', new Date(subscription.current_period_start * 1000).toISOString());
      console.log('📅 Stripe subscription period end:', new Date(subscription.current_period_end * 1000).toISOString());
